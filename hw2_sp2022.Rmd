...
pacman::p_load(ISLR, tidyverse, data.table, dplyr, tidyselect, skimr, corrplot, ggbiplot,factoextra,GGally) # add the packages needed
```
...
temp <- read.csv('Homework/HW2/data/NLSY79.csv', header = T, stringsAsFactors = F) %>%  filter(HeightFeet05 > 0, Income87 > 0, Job05 != "")
