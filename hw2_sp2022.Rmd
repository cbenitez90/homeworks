...
pacman::p_load(ISLR, tidyverse, data.table, dplyr, tidyselect, skimr, corrplot, ggbiplot) # add the packages needed
```
...
temp <- read.csv('data/NLSY79.csv', header = T, stringsAsFactors = F) %>%  filter(HeightFeet05 > 0, Income87 > 0, Job05 != "")
