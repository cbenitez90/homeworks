...
pacman::p_load(ISLR, readxl, magrittr, dplyr, ggplot2,GGally, stargazer,car) # add the packages needed
```
...
predict(Auto.model.revised3,newcar)
...
```{r}
#GGally::ggpairs(Auto)
summary(lm(gpm ~ cylinders*displacement + acceleration*horsepower + weight*horsepower +weight*horsepower + year + origin, data = Auto[,2:9]))
